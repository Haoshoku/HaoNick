...
public class HaoCommandHandler {
    ...
    public HaoCommandHandler() {
        ...
        HaoNickCommand haoNickCommand = new HaoNickCommand( "haonick",
                "Information about HaoNick", "/haonick reload", Arrays.asList( "/hn", "haon", "hnick" ));
        ...
        NickReloadCommand nickReloadCommand = new NickReloadCommand( config.getString( "commands.nick_reload_module.command" ),
        ...
        String haoNickModuleCommand = "haonick";
        ...
        this.registerCommandDynamically( "haonick", haoNickCommand );
    ...
    private void registerCommandDynamically( String command, BukkitCommand commandInstance ) {
        try {
            ...
            HaoNick.getPlugin().getLogger().log( Level.WARNING, "Failed to register " + command );
            e.printStackTrace();
        }
    }
